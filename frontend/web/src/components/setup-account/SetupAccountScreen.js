            ...
            <div className="row entry-screen">
                <div className="col-lg-6">
                    ...
                    <form>
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleInputPassword1" className="form-label">I am a</label>
                        ...
                        <div className="mb-5">
                            <label htmlFor="exampleInputPassword1" className="form-label">My course</label>
                            <select className="form-select" aria-label="Default select example">
                        ...
                        <div className="mb-5">
                            <button type="button" className="btn btn-primary w-100">Create my account</button>
                        </div>
                        <div>
