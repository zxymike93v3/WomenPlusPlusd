...
function SecondStep(props) {
  ...
  const fetchRoleTypes = useCallback(async () => {
    try {
      const response = await fetch(
        "https://edunity-backend.azurewebsites.net/role-types"
      );
      if (!response.ok) {
  ...
  const fetchCourseLocations = useCallback(async () => {
    try {
      const response = await fetch(
        "https://edunity-backend.azurewebsites.net/course-locations"
      );
      if (!response.ok) {
  ...
  const fetchCourses = useCallback(async () => {
    try {
      const response = await fetch(
        "https://edunity-backend.azurewebsites.net/courses"
      );
      if (!response.ok) {
  ...
  const fetchLanguages = useCallback(async () => {
    try {
      const response = await fetch(
        "https://edunity-backend.azurewebsites.net/supported-languages"
      );
      if (!response.ok) {
        throw new Error("Could not get courses");
      }
