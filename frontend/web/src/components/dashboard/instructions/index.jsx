  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="instructions__wrapper instructions__wrapper--left">
            ...
            <p className="instructions__text">You’re about to start your Global Health MCQ. Please read carefully the instructions and we wish you good luck!</p>
            <div className="instructions__buttons">
            <Button className="instructions__cancel" variant="outline-primary">Cancel</Button>
        ...
        <div className="instructions__wrapper instructions__wrapper--right">
            <div className="instruction__first">
                ...
                <div>
                    ...
                    <p>You have {timeLimit} to complete the exam. The counter starts as soon as you click on Start Exam.</p>
                </div>
                </div>
            </div>
            ...
            <img className="instruction__img" src={check} alt="check"/>
                <div>
                    ...
                    <p>This is a multiple choice question assessment.  You will be presented 4 answers but only 1 is correct.</p>
                </div>
            </div>
            </div>
            ...
            <div className="instruction__inner">
                ...
                <div>
                    ...
                    <p>You have a total of 30 questions to answer. You need to answer at least 16 of them correctly to pass.</p>
                </div>
            </div>
            </div>
            ...
            <div className="instruction__inner">
                ...
                <div>
                    <h6>Exam Mode</h6>
                    <p>During the exam mode, you are not allowed to leave the current tab nor to open other windows, tabs, files. All your answers are automatically saved, even when your internet connection is weak or offline.</p>
                </div>
            </div>
            </div>
            ...
            <div className="instruction__inner">
                ...
                <div>
                    <h6>General rules</h6>
                    <p>This is an individual exam. Once you start, you may not: talk to other students; use your phones; communicate digitally and there are no breaks. Not following these rules will automatically invalidate your assessment.</p>
                </div>
            </div>
            </div>
        </div>
